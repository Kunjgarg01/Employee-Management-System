...
const Card1 = ({ cardHeight = "350px", data }) => (
  ...
  >
    ...
    <div className="mt-auto pt-5">
      <span className="inline-block w-full text-center text-green-400 border border-green-400 rounded-lg bg-green-500/10 py-2 text-sm font-semibold select-none">
        Completed
      </span>
    </div>
  </motion.div>
